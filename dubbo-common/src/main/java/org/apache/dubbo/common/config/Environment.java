...
public class Environment extends LifecycleAdapter implements FrameworkExt {
    ...
    public synchronized CompositeConfiguration getPrefixedConfiguration(AbstractConfig config) {
        ...
        if (this.isConfigCenterFirst()) {
            ...
            prefixedConfiguration.addConfiguration(systemConfiguration);//系统变量
            prefixedConfiguration.addConfiguration(environmentConfiguration);//环境变量
            prefixedConfiguration.addConfiguration(appExternalConfiguration);//应用配置中心
            prefixedConfiguration.addConfiguration(externalConfiguration);//全局配置中心
            prefixedConfiguration.addConfiguration(configuration);
            prefixedConfiguration.addConfiguration(propertiesConfiguration);//dubbo.properties文件
        } else {
